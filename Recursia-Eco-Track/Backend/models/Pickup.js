...
const pickupSchema = new mongoose.Schema({
  ...
  wasteDetails: {
    type: {
      type: String,
      enum: ['organic', 'plastic', 'paper', 'electronic', 'hazardous', 'general', 'mixed'],
      required: true
    },
    subType: String, // e.g., "PET bottles", "Cardboard", "Laptop"
    estimatedWeight: { type: Number, default: 0 }, // in kg
    actualWeight: { type: Number, default: 0 }, // measured weight
    estimatedVolume: { type: Number, default: 0 }, // in cubic meters
    actualVolume: { type: Number, default: 0 },
    description: String,
    images: [String], // URLs to waste images
    specialHandling: {
      required: { type: Boolean, default: false },
      instructions: String,
      equipment: [String] // Required special equipment
    }
  },
