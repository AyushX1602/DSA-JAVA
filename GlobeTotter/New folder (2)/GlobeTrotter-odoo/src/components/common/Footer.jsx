        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Plan your perfect multi-city adventure with our intuitive travel planning tools. 
              Discover new destinations and create memories that last a lifetime.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/browse" className="text-gray-300 hover:text-white transition-colors">Browse Trips</Link></li>
