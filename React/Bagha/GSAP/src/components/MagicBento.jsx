...
const cardData = [
  {
    color: "#060010",
    title: "Creativity",
    description: "Photography, Videography & Design",
    label: "Insights",
  },
  { hasImage: true,
    color: "#060010",
  ...
  {
    color: "#060010",
    title: "Edits and Clips ",
    description: "Short videos and edits",
    label: "Shorts",
  },
  {
    color: "#060010",
...
const MagicBento = ({
  ...
  return (
    <>
      ...
      {/* Curved Loop Section */}
      <div className="w-full bg-gradient-to-b from-purple-900/20 to-transparent">
        <CurvedLoop 
          marqueeText="CREATIVE PORTFOLIO • BAGHA BOY • DESIGN & DEVELOPMENT • "
          speed={1.5}
          curveAmount={300}
          direction="left"
          interactive={true}
          ...
          {cardData.map((card, index) => {
            ...
            if (enableStars) {
              return (
                ...
                >
                  <div className="card__header flex justify-between  relative text-white font-bold">
                    <span className="card__label text-base">{card.label}</span>
                  </div>
                  {card.hasImage && (
                    <div className="card__image mb-3">
                      <img 
                        src={card.imageUrl} 
